        ...
        private void BtnGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (_model == null)
                {
                    ...
                    NBitacora.Registrar(SesionActual.IdUsuario, SesionActual.NombreUsuario, "Configuración", "CREAR", "puntos_emision", id, $"Crear punto emisión {codigo}", null, Environment.MachineName, "UI");
                }
                else
                {
                    p.Id = _model.Id;
                    NPuntoEmision.Actualizar(p);
                    NBitacora.Registrar(SesionActual.IdUsuario, SesionActual.NombreUsuario, "Configuración", "EDITAR", "puntos_emision", p.Id, $"Editar punto emisión {codigo}", null, Environment.MachineName, "UI");
                }
