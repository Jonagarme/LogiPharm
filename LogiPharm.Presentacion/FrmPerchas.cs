...
namespace LogiPharm.Presentacion
{
    public partial class FrmPerchas : Form
    {
        ...
        private void FrmPerchas_Load(object sender, EventArgs e)
        {
            ...
            try { NBitacora.Registrar(SesionActual.IdUsuario, SesionActual.NombreUsuario, "Inventario", "VISUALIZAR", "perchas", null, "Abrir Gestión de Perchas", null, Environment.MachineName, "UI"); } catch { }
