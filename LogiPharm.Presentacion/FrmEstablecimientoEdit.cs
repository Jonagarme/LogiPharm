        ...
        private void BtnGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (_model == null)
                {
                    ...
                    NBitacora.Registrar(SesionActual.IdUsuario, SesionActual.NombreUsuario, "Configuración", "CREAR", "establecimientos", id, $"Crear establecimiento {codigo}", null, Environment.MachineName, "UI");
                }
                else
                {
                    NEstablecimiento.Actualizar(_model.Id, codigo, nombre, direccion, estado);
                    NBitacora.Registrar(SesionActual.IdUsuario, SesionActual.NombreUsuario, "Configuración", "EDITAR", "establecimientos", _model.Id, $"Editar establecimiento {codigo}", null, Environment.MachineName, "UI");
                }
