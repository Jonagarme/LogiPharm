...
namespace LogiPharm.Presentacion.Utilidades
{
    ...
    public static class IconHelper
    {
        ...
        public const string IconExchange = "X";         // U+21C4 Exchange arrows
        public const string IconPlus = "X";            // U+2795 Heavy Plus
        public const string IconTimes = "X";            // U+2716 Heavy Multiplication X
        public const string IconCheck = "X";            // U+2714 Heavy Check Mark
        public const string IconSearch = "??";          // U+1F50D Magnifying glass
        public const string IconList = "??";            // U+1F4CB Clipboard
        public const string IconCog = "X";              // U+2699 Gear
        public const string IconArrowRight = "X";       // U+25B6 Right arrow
        ...
        public const string IconBarcode = "X";          // U+25A4 Square
        public const string IconTrash = "??";           // U+1F5D1 Wastebasket
        public const string IconEdit = "X";             // U+270F Pencil
        public const string IconInfo = "X";             // U+2139 Information
