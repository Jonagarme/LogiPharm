...
namespace LogiPharm.Presentacion
{
    public partial class FrmPuntosEmision : Form
    {
        ...
        {
            NBitacora.Registrar(SesionActual.IdUsuario, SesionActual.NombreUsuario, "Configuración", "VISUALIZAR", "puntos_emision", null, "Abrir Configuración de Puntos de Emisión", null, Environment.MachineName, "UI");
        ...
        private void btnEliminarEstab_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                NBitacora.Registrar(SesionActual.IdUsuario, SesionActual.NombreUsuario, "Configuración", "ELIMINAR", "establecimientos", id, $"Eliminar establecimiento {codigo}", null, Environment.MachineName, "UI");
                CargarEstablecimientos();
            }
            catch (Exception ex)
            {
        ...
        private void btnEliminarPunto_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                NBitacora.Registrar(SesionActual.IdUsuario, SesionActual.NombreUsuario, "Configuración", "ELIMINAR", "puntos_emision", id, $"Eliminar punto emisión {codigo}", null, Environment.MachineName, "UI");
                CargarPuntos(_idEstablecimientoActual);
            }
            catch (Exception ex)
            {
